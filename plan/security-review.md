...
| SR-11 | Unsafe catalog update, restore, or failed reload revives authority | Private-file checks reject unsafe paths/permissions; mixed revisions fail; failed reload reports the still-active generation; recovery requires current-policy review. [Catalog](catalog.md), [operations](operations.md); W2/W4/W8 |
